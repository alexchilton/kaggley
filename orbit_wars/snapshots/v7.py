...
# Variant patch: economy/opening constant tuning.
MAX_TURN_LAUNCHES = 6
OPENING_MIN_PRODUCTION = 1
ATTACK_COST_WEIGHT = 0.95
SNIPE_COST_WEIGHT = 1.25
STATIC_VALUE_MULT = 1.55
SAFE_NEUTRAL_VALUE_MULT = 1.35
EARLY_NEUTRAL_VALUE_MULT = 1.35
HOSTILE_VALUE_MULT = 1.72
OPENING_HOSTILE_VALUE_MULT = 1.25
