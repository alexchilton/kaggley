...
# Variant patch: strategic combo (lookahead + dynamic modes + opponent pressure).
REACTION_TOP_K = 4
class DecisionLogicV14(_LookaheadMixin, _OpponentPressureMixin, _DynamicModesMixin, DecisionLogic):
    def decide(self) -> List[List[float | int]]:
        try:
            self.reaction_map = self._build_reaction_map()
...
DecisionLogic = DecisionLogicV14
