...
# Variant patch: aggressive constant tuning.
MAX_TURN_LAUNCHES = 6
SWARM_ETA_TOLERANCE = 2
REACTION_TOP_K = 4
ATTACK_COST_WEIGHT = 0.68
SNIPE_COST_WEIGHT = 1.00
HOSTILE_VALUE_MULT = 2.05
OPENING_HOSTILE_VALUE_MULT = 1.60
SWARM_VALUE_MULT = 1.14
SAFE_NEUTRAL_VALUE_MULT = 1.08
