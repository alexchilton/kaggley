"""
Orbit Wars - wave: synchronized wave attacks
Key changes on top of v131_plus_2p:
- Pre-score pass each turn to find which target 3+ of my planets agree on
- Boost that target's score by WAVE_SCORE_BONUS for all planets
- Allow multiple planets to fire at the wave target in the same turn
"""
import os
