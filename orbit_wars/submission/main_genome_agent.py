...
DEFENSE_HORIZON = 28
COMET_LOOKAHEAD = 24  # overridden by genome block below

# ── GENOME PARAMETERS (edit these or set via GEN_* env vars) ──────────────
import os as _os
GENOME_SUN_ROUTING       = _os.environ.get('GEN_SUN_ROUTING',      '0') == '1'
GENOME_SMASH_TARGETS     = _os.environ.get('GEN_SMASH_TARGETS',    '0') == '1'
GENOME_COMET_LOOKAHEAD   = int(_os.environ.get('GEN_COMET_LOOKAHEAD', '24'))
GENOME_COMET_URGENCY     = _os.environ.get('GEN_COMET_URGENCY',    '0') == '1'
GENOME_INNER_ORBIT       = _os.environ.get('GEN_INNER_ORBIT',      '0') == '1'
GENOME_INNER_ORBIT_AMT   = float(_os.environ.get('GEN_INNER_ORBIT_AMT', '1.08'))
GENOME_INNER_ORBIT_SHIPS = int(_os.environ.get('GEN_INNER_ORBIT_SHIPS', '40'))
# ─────────────────────────────────────────────────────────────────────────────

# Override COMET_LOOKAHEAD with genome value
COMET_LOOKAHEAD = GENOME_COMET_LOOKAHEAD
...
FOUR_PLAYER_CAUTIOUS_LAUNCH_CAP = 6
...
FOUR_PLAYER_PREP_HOSTILE_DAMP = 0.92
