...
FOUR_PLAYER_PRESSURED_LAUNCH_CAP = 5
FOUR_PLAYER_FRONTLINE_DISTANCE = 24.0
FOUR_PLAYER_FRONTLINE_RESERVE_RATIO = 0.18
FOUR_PLAYER_DOUBLE_FRONT_RESERVE_RATIO = 0.28
FOUR_PLAYER_HOSTILE_VALUE_DAMP = 0.96
FOUR_PLAYER_SAFE_NEUTRAL_BONUS = 1.0
FOUR_PLAYER_PIVOT_PROD_RATIO = 1.18
FOUR_PLAYER_PIVOT_STAGE_DISTANCE = 30.0
FOUR_PLAYER_PIVOT_SAFE_NEUTRAL_LIMIT = 2
FOUR_PLAYER_PIVOT_HOSTILE_BONUS = 1.35
FOUR_PLAYER_PREP_HOSTILE_DAMP = 0.95
MTMR_OPENING_LAUNCH_CAP = 2
MTMR_DUEL_OPENING_LAUNCH_CAP = 5
