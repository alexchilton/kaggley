#!/usr/bin/env python3
"""Test smash fix v2: neutral fallback + delayed entry (3+ planets, step 20+)."""
...
print(f"2P TEST: v131-plus-2p (smash fix v2) vs v131 original")
print(f"Changes: smash needs 3+ planets & step>=20, neutral fallback in smash")
...
print(f"\n2P RESULT: v131-plus (smash fix v2) wins {wins_a}/{n_games} = {wr:.0%} vs v131 original")
